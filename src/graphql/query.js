...
export const SEARCH_ROOMS = gql`
  query SearchRooms($name: String, $location: String, $useDetailLocation: Boolean, $page: Int, $perPage: Int, $sortBy: String) {
    searchRoom(name: $name, location: $location, useDetailLocation: $useDetailLocation, page: $page, perPage: $perPage, sortBy: $sortBy) {
      nbHits
      nbPages
      hits {
      id
...
export const GET_ADMIN_LOGS_EXPORTS = gql`
  query GetLog($perPage: Int, $page: Int, $search: String, $useExport: Boolean){
    getAdminLogs(page: $page, perPage: $perPage, search: $search, useExport: $useExport) {
      nbHits
      nbPages
      hits {
        name
...
export const GET_COMMENTS_REPORTED = gql`
  query SearchComments ($perPage: Int, $page: Int, $sortBy: String, $filters: RequestFilter, $search: String, $useExport: Boolean) {
    searchCommentReported(search: $search, perPage: $perPage, page: $page, sortBy: $sortBy, filters: $filters, useExport: $useExport) {
      nbHits
      nbPages
      hits {
        text
